...
import { createToolRouter } from './routes/new';
import { showToolRouter } from './routes/show';
import { indexToolRouter } from './routes/index';
import { updateToolRouter } from './routes/update';
import { deleteToolRouter } from './routes/delete';
...
app.use(showToolRouter);
app.use(indexToolRouter);
app.use(updateToolRouter);
app.use(deleteToolRouter);
